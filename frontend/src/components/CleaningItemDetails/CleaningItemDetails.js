...
class CleaningItemDetails extends Component {
  state = {
    details: {},
    images: [],
    relatedClenaingData: [],
  ...
  getRealatedItems = async () => {
    ...
    if (response.ok === true) {
      ...
      this.setState({
        relatedHomeAppliencesData: responseData,
      })
    }
  }
  ...
  render() {
    const { details, images, relatedClenaingData, comments, commentStatus } =
      this.state
    console.log(details)
...
export default CleaningItemDetails
