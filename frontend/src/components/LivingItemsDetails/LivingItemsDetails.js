...
class LivingItemsDetails extends Component {
  state = {
    details: {},
    images: [],
    relatedLivingroomData: [],
  ...
  getDetails = async () => {
    ...
    const url = `https://casa-mart.onrender.com/livingroomitems/${id}`
  ...
  getRelatedProducts = async () => {
    ...
    if (response.ok === true) {
      ...
      this.setState({
        relatedLivingroomData: responseData,
      })
    }
  }
  ...
  render() {
    const { details, images, relatedLivingroomData, comments, commentStatus } =
      this.state
    console.log(details)
            ...
            <div className="w-full flex flex-col items-center justify-center">
              ...
              <div className="mt-6 p-4 w-4/5 border rounded shadow-md bg-gray-100">
                ...
                <div className="flex overflow-x-auto space-x-4 p-4 scrollbar-hide  ">
                  {relatedLivingroomData.map((each) => (
...
export default LivingItemsDetails
