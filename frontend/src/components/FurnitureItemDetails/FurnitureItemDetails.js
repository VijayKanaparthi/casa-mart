...
class FurnitureItemDetails extends Component {
  state = {
    details: {},
    images: [],
  ...
  getRelatedProducts = async () => {
    ...
    if (response.ok === true) {
      ...
      this.setState({
        relatedFurnitureData: responseData,
      })
    }
  }
  ...
  render() {
    const { details, images, relatedFurnitureData, comments, commentStatus } =
      this.state
    console.log(details)
